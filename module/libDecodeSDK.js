...
function _AACEnc_GetVersion() {
  err("missing function: AACEnc_GetVersion");
  abort(-1);
}
function _AAC_Enc_DeInit() {
  err("missing function: AAC_Enc_DeInit");
  abort(-1);
}
function _AAC_Enc_Encode() {
  err("missing function: AAC_Enc_Encode");
  abort(-1);
}
function _AAC_Enc_Flush() {
  err("missing function: AAC_Enc_Flush");
  abort(-1);
}
function _AAC_Enc_Init() {
  err("missing function: AAC_Enc_Init");
  abort(-1);
}
function _AAC_Enc_SetFormat() {
  err("missing function: AAC_Enc_SetFormat");
  abort(-1);
}
...
function _FDK_AACDec_GetVersion() {
  err("missing function: FDK_AACDec_GetVersion");
  abort(-1);
}
function _FDK_AACEnc_GetVersion() {
  err("missing function: FDK_AACEnc_GetVersion");
  abort(-1);
}
function _FDK_AAC_DEC_Cleanup() {
  err("missing function: FDK_AAC_DEC_Cleanup");
  abort(-1);
}
function _FDK_AAC_DEC_Decode() {
  err("missing function: FDK_AAC_DEC_Decode");
  abort(-1);
}
function _FDK_AAC_DEC_Decode_Frame() {
  err("missing function: FDK_AAC_DEC_Decode_Frame");
  abort(-1);
}
function _FDK_AAC_DEC_Flush() {
  err("missing function: FDK_AAC_DEC_Flush");
  abort(-1);
}
function _FDK_AAC_DEC_GetSize() {
  err("missing function: FDK_AAC_DEC_GetSize");
  abort(-1);
}
function _FDK_AAC_DEC_Init() {
  err("missing function: FDK_AAC_DEC_Init");
  abort(-1);
}
function _FDK_AAC_DEC_Reset() {
  err("missing function: FDK_AAC_DEC_Reset");
  abort(-1);
}
function _FDK_AAC_Enc_DeInit() {
  err("missing function: FDK_AAC_Enc_DeInit");
  abort(-1);
}
function _FDK_AAC_Enc_Encode() {
  err("missing function: FDK_AAC_Enc_Encode");
  abort(-1);
}
function _FDK_AAC_Enc_Flush() {
  err("missing function: FDK_AAC_Enc_Flush");
  abort(-1);
}
function _FDK_AAC_Enc_Init() {
  err("missing function: FDK_AAC_Enc_Init");
  abort(-1);
}
function _FDK_AAC_Enc_SetFormat() {
  err("missing function: FDK_AAC_Enc_SetFormat");
  abort(-1);
}
function _G7221_Dec_DeInit() {
  err("missing function: G7221_Dec_DeInit");
  abort(-1);
}
function _G7221_Dec_Flush() {
  err("missing function: G7221_Dec_Flush");
  abort(-1);
}
function _G7221_Dec_Init() {
  err("missing function: G7221_Dec_Init");
  abort(-1);
}
function _G7221_Dec_SetFormat() {
  err("missing function: G7221_Dec_SetFormat");
  abort(-1);
}
function _G7221_Decode() {
  err("missing function: G7221_Decode");
  abort(-1);
}
function _G7221_Enc_DeInit() {
  err("missing function: G7221_Enc_DeInit");
  abort(-1);
}
function _G7221_Enc_Flush() {
  err("missing function: G7221_Enc_Flush");
  abort(-1);
}
function _G7221_Enc_Init() {
  err("missing function: G7221_Enc_Init");
  abort(-1);
}
function _G7221_Enc_SetFormat() {
  err("missing function: G7221_Enc_SetFormat");
  abort(-1);
}
function _G7221_Encode() {
  err("missing function: G7221_Encode");
  abort(-1);
}
function _G7222_Dec() {
  err("missing function: G7222_Dec");
  abort(-1);
}
function _G7222_Dec_DeInit() {
  err("missing function: G7222_Dec_DeInit");
  abort(-1);
}
function _G7222_Dec_Flush() {
  err("missing function: G7222_Dec_Flush");
  abort(-1);
}
function _G7222_Dec_GetVersion() {
  err("missing function: G7222_Dec_GetVersion");
  abort(-1);
}
function _G7222_Dec_Init() {
  err("missing function: G7222_Dec_Init");
  abort(-1);
}
function _G7222_Enc() {
  err("missing function: G7222_Enc");
  abort(-1);
}
function _G7222_Enc_DeInit() {
  err("missing function: G7222_Enc_DeInit");
  abort(-1);
}
function _G7222_Enc_Flush() {
  err("missing function: G7222_Enc_Flush");
  abort(-1);
}
function _G7222_Enc_GetVersion() {
  err("missing function: G7222_Enc_GetVersion");
  abort(-1);
}
function _G7222_Enc_Init() {
  err("missing function: G7222_Enc_Init");
  abort(-1);
}
function _G7222_Enc_SetFormat() {
  err("missing function: G7222_Enc_SetFormat");
  abort(-1);
}
function _G722_Dec_DeInit() {
  err("missing function: G722_Dec_DeInit");
  abort(-1);
}
function _G722_Dec_Flush() {
  err("missing function: G722_Dec_Flush");
  abort(-1);
}
function _G722_Dec_GetVersion() {
  err("missing function: G722_Dec_GetVersion");
  abort(-1);
}
function _G722_Dec_Init() {
  err("missing function: G722_Dec_Init");
  abort(-1);
}
function _G722_Dec_SetFormat() {
  err("missing function: G722_Dec_SetFormat");
  abort(-1);
}
function _G722_Decode() {
  err("missing function: G722_Decode");
  abort(-1);
}
function _G722_Enc_DeInit() {
  err("missing function: G722_Enc_DeInit");
  abort(-1);
}
function _G722_Enc_Flush() {
  err("missing function: G722_Enc_Flush");
  abort(-1);
}
function _G722_Enc_Init() {
  err("missing function: G722_Enc_Init");
  abort(-1);
}
function _G722_Enc_SetFormat() {
  err("missing function: G722_Enc_SetFormat");
  abort(-1);
}
function _G722_Encode() {
  err("missing function: G722_Encode");
  abort(-1);
}
function _G728_Dec_SetFormat() {
  err("missing function: G728_Dec_SetFormat");
  abort(-1);
}
function _G728_Enc_SetFormat() {
  err("missing function: G728_Enc_SetFormat");
  abort(-1);
}
function _IMA_Cleanup() {
  err("missing function: IMA_Cleanup");
  abort(-1);
}
function _IMA_Decode() {
  err("missing function: IMA_Decode");
  abort(-1);
}
function _IMA_Encode() {
  err("missing function: IMA_Encode");
  abort(-1);
}
function _IMA_Flush() {
  err("missing function: IMA_Flush");
  abort(-1);
}
function _IMA_Init() {
  err("missing function: IMA_Init");
  abort(-1);
}
function _IMA_Reset() {
  err("missing function: IMA_Reset");
  abort(-1);
}
...
function _MP2L2_enc() {
  err("missing function: MP2L2_enc");
  abort(-1);
}
function _MP2L2_enc_GetVersion() {
  err("missing function: MP2L2_enc_GetVersion");
  abort(-1);
}
function _MP2L2_enc_deInit() {
  err("missing function: MP2L2_enc_deInit");
  abort(-1);
}
function _MP2L2_enc_flush() {
  err("missing function: MP2L2_enc_flush");
  abort(-1);
}
function _MP2L2_enc_init() {
  err("missing function: MP2L2_enc_init");
  abort(-1);
}
function _MP2L2_enc_setFormat() {
  err("missing function: MP2L2_enc_setFormat");
  abort(-1);
}
function _MP3_dec() {
  err("missing function: MP3_dec");
  abort(-1);
}
function _MP3_dec_Frame() {
  err("missing function: MP3_dec_Frame");
  abort(-1);
}
function _MP3_dec_GetSize() {
  err("missing function: MP3_dec_GetSize");
  abort(-1);
}
function _MP3_dec_deInit() {
  err("missing function: MP3_dec_deInit");
  abort(-1);
}
function _MP3_dec_flush() {
  err("missing function: MP3_dec_flush");
  abort(-1);
}
function _MP3_dec_init() {
  err("missing function: MP3_dec_init");
  abort(-1);
}
function _MP3_dec_reset() {
  err("missing function: MP3_dec_reset");
  abort(-1);
}
function _MP3_enc() {
  err("missing function: MP3_enc");
  abort(-1);
}
function _MP3_enc_deInit() {
  err("missing function: MP3_enc_deInit");
  abort(-1);
}
function _MP3_enc_flush() {
  err("missing function: MP3_enc_flush");
  abort(-1);
}
function _MP3_enc_init() {
  err("missing function: MP3_enc_init");
  abort(-1);
}
function _MP3_enc_setFormat() {
  err("missing function: MP3_enc_setFormat");
  abort(-1);
}
function _OPUS_CODEC_GetVersion() {
  err("missing function: OPUS_CODEC_GetVersion");
  abort(-1);
}
function _OPUS_Dec_DeInit() {
  err("missing function: OPUS_Dec_DeInit");
  abort(-1);
}
function _OPUS_Dec_Decode() {
  err("missing function: OPUS_Dec_Decode");
  abort(-1);
}
function _OPUS_Dec_Decode_Frame() {
  err("missing function: OPUS_Dec_Decode_Frame");
  abort(-1);
}
function _OPUS_Dec_Flush() {
  err("missing function: OPUS_Dec_Flush");
  abort(-1);
}
function _OPUS_Dec_GetSize() {
  err("missing function: OPUS_Dec_GetSize");
  abort(-1);
}
function _OPUS_Dec_Init() {
  err("missing function: OPUS_Dec_Init");
  abort(-1);
}
function _OPUS_Dec_SetFormat() {
  err("missing function: OPUS_Dec_SetFormat");
  abort(-1);
}
function _OPUS_Enc_DeInit() {
  err("missing function: OPUS_Enc_DeInit");
  abort(-1);
}
function _OPUS_Enc_Encode() {
  err("missing function: OPUS_Enc_Encode");
  abort(-1);
}
function _OPUS_Enc_Flush() {
  err("missing function: OPUS_Enc_Flush");
  abort(-1);
}
function _OPUS_Enc_Init() {
  err("missing function: OPUS_Enc_Init");
  abort(-1);
}
function _OPUS_Enc_SetFormat() {
  err("missing function: OPUS_Enc_SetFormat");
  abort(-1);
}
function _SPEEX_CODEC_GetVersion() {
  err("missing function: SPEEX_CODEC_GetVersion");
  abort(-1);
}
function _SPEEX_Dec_DeInit() {
  err("missing function: SPEEX_Dec_DeInit");
  abort(-1);
}
function _SPEEX_Dec_Decode() {
  err("missing function: SPEEX_Dec_Decode");
  abort(-1);
}
function _SPEEX_Dec_Decode_Frame() {
  err("missing function: SPEEX_Dec_Decode_Frame");
  abort(-1);
}
function _SPEEX_Dec_Flush() {
  err("missing function: SPEEX_Dec_Flush");
  abort(-1);
}
function _SPEEX_Dec_GetSize() {
  err("missing function: SPEEX_Dec_GetSize");
  abort(-1);
}
function _SPEEX_Dec_Init() {
  err("missing function: SPEEX_Dec_Init");
  abort(-1);
}
function _SPEEX_Dec_SetFormat() {
  err("missing function: SPEEX_Dec_SetFormat");
  abort(-1);
}
function _SPEEX_Enc_DeInit() {
  err("missing function: SPEEX_Enc_DeInit");
  abort(-1);
}
function _SPEEX_Enc_Encode() {
  err("missing function: SPEEX_Enc_Encode");
  abort(-1);
}
function _SPEEX_Enc_Flush() {
  err("missing function: SPEEX_Enc_Flush");
  abort(-1);
}
function _SPEEX_Enc_Init() {
  err("missing function: SPEEX_Enc_Init");
  abort(-1);
}
function _SPEEX_Enc_SetFormat() {
  err("missing function: SPEEX_Enc_SetFormat");
  abort(-1);
}
...
function _adpcm_GetVersion() {
  err("missing function: adpcm_GetVersion");
  abort(-1);
}
function _amr_Dec_GetVersion() {
  err("missing function: amr_Dec_GetVersion");
  abort(-1);
}
function _amr_Enc_DeInit() {
  err("missing function: amr_Enc_DeInit");
  abort(-1);
}
function _amr_Enc_Encode() {
  err("missing function: amr_Enc_Encode");
  abort(-1);
}
function _amr_Enc_Flush() {
  err("missing function: amr_Enc_Flush");
  abort(-1);
}
function _amr_Enc_GetVersion() {
  err("missing function: amr_Enc_GetVersion");
  abort(-1);
}
function _amr_Enc_Init() {
  err("missing function: amr_Enc_Init");
  abort(-1);
}
function _amr_Enc_SetFormat() {
  err("missing function: amr_Enc_SetFormat");
  abort(-1);
}
function _amr_dec_close() {
  err("missing function: amr_dec_close");
  abort(-1);
}
function _amr_dec_flush() {
  err("missing function: amr_dec_flush");
  abort(-1);
}
function _amr_dec_open() {
  err("missing function: amr_dec_open");
  abort(-1);
}
function _amr_dec_reset() {
  err("missing function: amr_dec_reset");
  abort(-1);
}
function _amr_dec_write() {
  err("missing function: amr_dec_write");
  abort(-1);
}
function _clock() {
...
function _g719_dec() {
  err("missing function: g719_dec");
  abort(-1);
}
function _g719_dec_GetVersion() {
  err("missing function: g719_dec_GetVersion");
  abort(-1);
}
function _g719_dec_deInit() {
  err("missing function: g719_dec_deInit");
  abort(-1);
}
function _g719_dec_flush() {
  err("missing function: g719_dec_flush");
  abort(-1);
}
function _g719_dec_init() {
  err("missing function: g719_dec_init");
  abort(-1);
}
function _g719_dec_setFormat() {
  err("missing function: g719_dec_setFormat");
  abort(-1);
}
function _g719_enc() {
  err("missing function: g719_enc");
  abort(-1);
}
function _g719_enc_GetVersion() {
  err("missing function: g719_enc_GetVersion");
  abort(-1);
}
function _g719_enc_deInit() {
  err("missing function: g719_enc_deInit");
  abort(-1);
}
function _g719_enc_flush() {
  err("missing function: g719_enc_flush");
  abort(-1);
}
function _g719_enc_init() {
  err("missing function: g719_enc_init");
  abort(-1);
}
function _g719_enc_setFormat() {
  err("missing function: g719_enc_setFormat");
  abort(-1);
}
function _g7221_Dec_GetVersion() {
  err("missing function: g7221_Dec_GetVersion");
  abort(-1);
}
function _g7221_Enc_GetVersion() {
  err("missing function: g7221_Enc_GetVersion");
  abort(-1);
}
function _g722Enc_GetVersion() {
  err("missing function: g722Enc_GetVersion");
  abort(-1);
}
function _g723Enc_GetVersion() {
  err("missing function: g723Enc_GetVersion");
  abort(-1);
}
function _g723enc() {
  err("missing function: g723enc");
  abort(-1);
}
function _g723enc_deInit() {
  err("missing function: g723enc_deInit");
  abort(-1);
}
function _g723enc_flush() {
  err("missing function: g723enc_flush");
  abort(-1);
}
function _g723enc_init() {
  err("missing function: g723enc_init");
  abort(-1);
}
function _g723enc_setMode() {
  err("missing function: g723enc_setMode");
  abort(-1);
}
function _g726_enc() {
  err("missing function: g726_enc");
  abort(-1);
}
function _g726_enc_GetVersion() {
  err("missing function: g726_enc_GetVersion");
  abort(-1);
}
function _g726_enc_deInit() {
  err("missing function: g726_enc_deInit");
  abort(-1);
}
function _g726_enc_init() {
  err("missing function: g726_enc_init");
  abort(-1);
}
function _g726_enc_setFormat() {
  err("missing function: g726_enc_setFormat");
  abort(-1);
}
function _g728_dec() {
  err("missing function: g728_dec");
  abort(-1);
}
function _g728_dec_GetVersion() {
  err("missing function: g728_dec_GetVersion");
  abort(-1);
}
function _g728_dec_deInit() {
  err("missing function: g728_dec_deInit");
  abort(-1);
}
function _g728_dec_flush() {
  err("missing function: g728_dec_flush");
  abort(-1);
}
function _g728_dec_init() {
  err("missing function: g728_dec_init");
  abort(-1);
}
function _g728_enc() {
  err("missing function: g728_enc");
  abort(-1);
}
function _g728_enc_GetVersion() {
  err("missing function: g728_enc_GetVersion");
  abort(-1);
}
function _g728_enc_deInit() {
  err("missing function: g728_enc_deInit");
  abort(-1);
}
function _g728_enc_flush() {
  err("missing function: g728_enc_flush");
  abort(-1);
}
function _g728_enc_init() {
  err("missing function: g728_enc_init");
  abort(-1);
}
function _g729ab_enc() {
  err("missing function: g729ab_enc");
  abort(-1);
}
function _g729ab_enc_GetVersion() {
  err("missing function: g729ab_enc_GetVersion");
  abort(-1);
}
function _g729ab_enc_deInit() {
  err("missing function: g729ab_enc_deInit");
  abort(-1);
}
function _g729ab_enc_flush() {
  err("missing function: g729ab_enc_flush");
  abort(-1);
}
function _g729ab_enc_init() {
  err("missing function: g729ab_enc_init");
  abort(-1);
}
function _g729ab_enc_setFormat() {
  err("missing function: g729ab_enc_setFormat");
  abort(-1);
}
...
function _mp3Dec_GetVersion() {
  err("missing function: mp3Dec_GetVersion");
  abort(-1);
}
function _mp3Enc_GetVersion() {
  err("missing function: mp3Enc_GetVersion");
  abort(-1);
}
...
function _vorbis_dec() {
  err("missing function: vorbis_dec");
  abort(-1);
}
function _vorbis_dec_Frame() {
  err("missing function: vorbis_dec_Frame");
  abort(-1);
}
function _vorbis_dec_GetSize() {
  err("missing function: vorbis_dec_GetSize");
  abort(-1);
}
function _vorbis_dec_GetVersion() {
  err("missing function: vorbis_dec_GetVersion");
  abort(-1);
}
function _vorbis_dec_Reset() {
  err("missing function: vorbis_dec_Reset");
  abort(-1);
}
function _vorbis_dec_deInit() {
  err("missing function: vorbis_dec_deInit");
  abort(-1);
}
function _vorbis_dec_flush() {
  err("missing function: vorbis_dec_flush");
  abort(-1);
}
function _vorbis_dec_init() {
  err("missing function: vorbis_dec_init");
  abort(-1);
}
function _vorbis_enc() {
  err("missing function: vorbis_enc");
  abort(-1);
}
function _vorbis_enc_GetVersion() {
  err("missing function: vorbis_enc_GetVersion");
  abort(-1);
}
function _vorbis_enc_deInit() {
  err("missing function: vorbis_enc_deInit");
  abort(-1);
}
function _vorbis_enc_flush() {
  err("missing function: vorbis_enc_flush");
  abort(-1);
}
function _vorbis_enc_init() {
  err("missing function: vorbis_enc_init");
  abort(-1);
}
function _vorbis_enc_setFormat() {
  err("missing function: vorbis_enc_setFormat");
  abort(-1);
}
...
var asmLibraryArg = {
  AACEnc_GetVersion: _AACEnc_GetVersion,
  AAC_Enc_DeInit: _AAC_Enc_DeInit,
  AAC_Enc_Encode: _AAC_Enc_Encode,
  AAC_Enc_Flush: _AAC_Enc_Flush,
  AAC_Enc_Init: _AAC_Enc_Init,
  AAC_Enc_SetFormat: _AAC_Enc_SetFormat,
  DHHEVC_ff_thread_report_il_status: _DHHEVC_ff_thread_report_il_status,
  FDK_AACDec_GetVersion: _FDK_AACDec_GetVersion,
  FDK_AACEnc_GetVersion: _FDK_AACEnc_GetVersion,
  FDK_AAC_DEC_Cleanup: _FDK_AAC_DEC_Cleanup,
  FDK_AAC_DEC_Decode: _FDK_AAC_DEC_Decode,
  FDK_AAC_DEC_Decode_Frame: _FDK_AAC_DEC_Decode_Frame,
  FDK_AAC_DEC_Flush: _FDK_AAC_DEC_Flush,
  FDK_AAC_DEC_GetSize: _FDK_AAC_DEC_GetSize,
  FDK_AAC_DEC_Init: _FDK_AAC_DEC_Init,
  FDK_AAC_DEC_Reset: _FDK_AAC_DEC_Reset,
  FDK_AAC_Enc_DeInit: _FDK_AAC_Enc_DeInit,
  FDK_AAC_Enc_Encode: _FDK_AAC_Enc_Encode,
  FDK_AAC_Enc_Flush: _FDK_AAC_Enc_Flush,
  FDK_AAC_Enc_Init: _FDK_AAC_Enc_Init,
  FDK_AAC_Enc_SetFormat: _FDK_AAC_Enc_SetFormat,
  G7221_Dec_DeInit: _G7221_Dec_DeInit,
  G7221_Dec_Flush: _G7221_Dec_Flush,
  G7221_Dec_Init: _G7221_Dec_Init,
  G7221_Dec_SetFormat: _G7221_Dec_SetFormat,
  G7221_Decode: _G7221_Decode,
  G7221_Enc_DeInit: _G7221_Enc_DeInit,
  G7221_Enc_Flush: _G7221_Enc_Flush,
  G7221_Enc_Init: _G7221_Enc_Init,
  G7221_Enc_SetFormat: _G7221_Enc_SetFormat,
  G7221_Encode: _G7221_Encode,
  G7222_Dec: _G7222_Dec,
  G7222_Dec_DeInit: _G7222_Dec_DeInit,
  G7222_Dec_Flush: _G7222_Dec_Flush,
  G7222_Dec_GetVersion: _G7222_Dec_GetVersion,
  G7222_Dec_Init: _G7222_Dec_Init,
  G7222_Enc: _G7222_Enc,
  G7222_Enc_DeInit: _G7222_Enc_DeInit,
  G7222_Enc_Flush: _G7222_Enc_Flush,
  G7222_Enc_GetVersion: _G7222_Enc_GetVersion,
  G7222_Enc_Init: _G7222_Enc_Init,
  G7222_Enc_SetFormat: _G7222_Enc_SetFormat,
  G722_Dec_DeInit: _G722_Dec_DeInit,
  G722_Dec_Flush: _G722_Dec_Flush,
  G722_Dec_GetVersion: _G722_Dec_GetVersion,
  G722_Dec_Init: _G722_Dec_Init,
  G722_Dec_SetFormat: _G722_Dec_SetFormat,
  G722_Decode: _G722_Decode,
  G722_Enc_DeInit: _G722_Enc_DeInit,
  G722_Enc_Flush: _G722_Enc_Flush,
  G722_Enc_Init: _G722_Enc_Init,
  G722_Enc_SetFormat: _G722_Enc_SetFormat,
  G722_Encode: _G722_Encode,
  G728_Dec_SetFormat: _G728_Dec_SetFormat,
  G728_Enc_SetFormat: _G728_Enc_SetFormat,
  IMA_Cleanup: _IMA_Cleanup,
  IMA_Decode: _IMA_Decode,
  IMA_Encode: _IMA_Encode,
  IMA_Flush: _IMA_Flush,
  IMA_Init: _IMA_Init,
  IMA_Reset: _IMA_Reset,
  JPEG_Dec_Close: _JPEG_Dec_Close,
  JPEG_Dec_Decode: _JPEG_Dec_Decode,
  JPEG_Dec_Init: _JPEG_Dec_Init,
  JPEG_Dec_Open: _JPEG_Dec_Open,
  MP2L2_enc: _MP2L2_enc,
  MP2L2_enc_GetVersion: _MP2L2_enc_GetVersion,
  MP2L2_enc_deInit: _MP2L2_enc_deInit,
  MP2L2_enc_flush: _MP2L2_enc_flush,
  MP2L2_enc_init: _MP2L2_enc_init,
  MP2L2_enc_setFormat: _MP2L2_enc_setFormat,
  MP3_dec: _MP3_dec,
  MP3_dec_Frame: _MP3_dec_Frame,
  MP3_dec_GetSize: _MP3_dec_GetSize,
  MP3_dec_deInit: _MP3_dec_deInit,
  MP3_dec_flush: _MP3_dec_flush,
  MP3_dec_init: _MP3_dec_init,
  MP3_dec_reset: _MP3_dec_reset,
  MP3_enc: _MP3_enc,
  MP3_enc_deInit: _MP3_enc_deInit,
  MP3_enc_flush: _MP3_enc_flush,
  MP3_enc_init: _MP3_enc_init,
  MP3_enc_setFormat: _MP3_enc_setFormat,
  OPUS_CODEC_GetVersion: _OPUS_CODEC_GetVersion,
  OPUS_Dec_DeInit: _OPUS_Dec_DeInit,
  OPUS_Dec_Decode: _OPUS_Dec_Decode,
  OPUS_Dec_Decode_Frame: _OPUS_Dec_Decode_Frame,
  OPUS_Dec_Flush: _OPUS_Dec_Flush,
  OPUS_Dec_GetSize: _OPUS_Dec_GetSize,
  OPUS_Dec_Init: _OPUS_Dec_Init,
  OPUS_Dec_SetFormat: _OPUS_Dec_SetFormat,
  OPUS_Enc_DeInit: _OPUS_Enc_DeInit,
  OPUS_Enc_Encode: _OPUS_Enc_Encode,
  OPUS_Enc_Flush: _OPUS_Enc_Flush,
  OPUS_Enc_Init: _OPUS_Enc_Init,
  OPUS_Enc_SetFormat: _OPUS_Enc_SetFormat,
  SPEEX_CODEC_GetVersion: _SPEEX_CODEC_GetVersion,
  SPEEX_Dec_DeInit: _SPEEX_Dec_DeInit,
  SPEEX_Dec_Decode: _SPEEX_Dec_Decode,
  SPEEX_Dec_Decode_Frame: _SPEEX_Dec_Decode_Frame,
  SPEEX_Dec_Flush: _SPEEX_Dec_Flush,
  SPEEX_Dec_GetSize: _SPEEX_Dec_GetSize,
  SPEEX_Dec_Init: _SPEEX_Dec_Init,
  SPEEX_Dec_SetFormat: _SPEEX_Dec_SetFormat,
  SPEEX_Enc_DeInit: _SPEEX_Enc_DeInit,
  SPEEX_Enc_Encode: _SPEEX_Enc_Encode,
  SPEEX_Enc_Flush: _SPEEX_Enc_Flush,
  SPEEX_Enc_Init: _SPEEX_Enc_Init,
  SPEEX_Enc_SetFormat: _SPEEX_Enc_SetFormat,
  ...
  abort: _abort,
  adpcm_GetVersion: _adpcm_GetVersion,
  amr_Dec_GetVersion: _amr_Dec_GetVersion,
  amr_Enc_DeInit: _amr_Enc_DeInit,
  amr_Enc_Encode: _amr_Enc_Encode,
  amr_Enc_Flush: _amr_Enc_Flush,
  amr_Enc_GetVersion: _amr_Enc_GetVersion,
  amr_Enc_Init: _amr_Enc_Init,
  amr_Enc_SetFormat: _amr_Enc_SetFormat,
  amr_dec_close: _amr_dec_close,
  amr_dec_flush: _amr_dec_flush,
  amr_dec_open: _amr_dec_open,
  amr_dec_reset: _amr_dec_reset,
  amr_dec_write: _amr_dec_write,
  clock: _clock,
  dlclose: _dlclose,
  dlopen: _dlopen,
  dlsym: _dlsym,
  ...
  fd_write: _fd_write,
  g719_dec: _g719_dec,
  g719_dec_GetVersion: _g719_dec_GetVersion,
  g719_dec_deInit: _g719_dec_deInit,
  g719_dec_flush: _g719_dec_flush,
  g719_dec_init: _g719_dec_init,
  g719_dec_setFormat: _g719_dec_setFormat,
  g719_enc: _g719_enc,
  g719_enc_GetVersion: _g719_enc_GetVersion,
  g719_enc_deInit: _g719_enc_deInit,
  g719_enc_flush: _g719_enc_flush,
  g719_enc_init: _g719_enc_init,
  g719_enc_setFormat: _g719_enc_setFormat,
  g7221_Dec_GetVersion: _g7221_Dec_GetVersion,
  g7221_Enc_GetVersion: _g7221_Enc_GetVersion,
  g722Enc_GetVersion: _g722Enc_GetVersion,
  g723Enc_GetVersion: _g723Enc_GetVersion,
  g723enc: _g723enc,
  g723enc_deInit: _g723enc_deInit,
  g723enc_flush: _g723enc_flush,
  g723enc_init: _g723enc_init,
  g723enc_setMode: _g723enc_setMode,
  g726_enc: _g726_enc,
  g726_enc_GetVersion: _g726_enc_GetVersion,
  g726_enc_deInit: _g726_enc_deInit,
  g726_enc_init: _g726_enc_init,
  g726_enc_setFormat: _g726_enc_setFormat,
  g728_dec: _g728_dec,
  g728_dec_GetVersion: _g728_dec_GetVersion,
  g728_dec_deInit: _g728_dec_deInit,
  g728_dec_flush: _g728_dec_flush,
  g728_dec_init: _g728_dec_init,
  g728_enc: _g728_enc,
  g728_enc_GetVersion: _g728_enc_GetVersion,
  g728_enc_deInit: _g728_enc_deInit,
  g728_enc_flush: _g728_enc_flush,
  g728_enc_init: _g728_enc_init,
  g729ab_enc: _g729ab_enc,
  g729ab_enc_GetVersion: _g729ab_enc_GetVersion,
  g729ab_enc_deInit: _g729ab_enc_deInit,
  g729ab_enc_flush: _g729ab_enc_flush,
  g729ab_enc_init: _g729ab_enc_init,
  g729ab_enc_setFormat: _g729ab_enc_setFormat,
  gettimeofday: _gettimeofday,
  mktime: _mktime,
  mp3Dec_GetVersion: _mp3Dec_GetVersion,
  mp3Enc_GetVersion: _mp3Enc_GetVersion,
  pthread_create: _pthread_create,
  pthread_join: _pthread_join,
  setTempRet0: _setTempRet0,
  strftime_l: _strftime_l,
  time: _time,
  vorbis_dec: _vorbis_dec,
  vorbis_dec_Frame: _vorbis_dec_Frame,
  vorbis_dec_GetSize: _vorbis_dec_GetSize,
  vorbis_dec_GetVersion: _vorbis_dec_GetVersion,
  vorbis_dec_Reset: _vorbis_dec_Reset,
  vorbis_dec_deInit: _vorbis_dec_deInit,
  vorbis_dec_flush: _vorbis_dec_flush,
  vorbis_dec_init: _vorbis_dec_init,
  vorbis_enc: _vorbis_enc,
  vorbis_enc_GetVersion: _vorbis_enc_GetVersion,
  vorbis_enc_deInit: _vorbis_enc_deInit,
  vorbis_enc_flush: _vorbis_enc_flush,
  vorbis_enc_init: _vorbis_enc_init,
  vorbis_enc_setFormat: _vorbis_enc_setFormat,
};
var asm = createWasm();
