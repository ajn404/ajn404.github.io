import{j as u}from"./jsx-runtime.BlJElA5X.js";import{r as o}from"./index.KNIQqnlE.js";import{C as g,u as p,b as h}from"./react-three-fiber.esm.DXOLdOrB.js";import{P as x,S as b,V as v}from"./three.module.BN9nGcjX.js";import{S as w}from"./slider.Ca9EgSnL.js";import{c as y}from"./utils.DGLjwLc1.js";import{u as _}from"./index.BTsA0VWg.js";import"./_sentry-release-injection-file.b82t1l8g.js";import"./_commonjsHelpers.DWWLd87L.js";import"./index.BBXd5jpg.js";import"./index.CudXchKt.js";import"./index.DS2glMWq.js";import"./index.B2dbCyJN.js";import"./index.lfrod4K5.js";import"./index.PcWGclEp.js";(function(){try{var n=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{},i=new n.Error().stack;i&&(n._sentryDebugIds=n._sentryDebugIds||{},n._sentryDebugIds[i]="3aa4502b-0876-40fa-b260-a3286d81cd24",n._sentryDebugIdIdentifier="sentry-dbid-3aa4502b-0876-40fa-b260-a3286d81cd24")}catch{}})();const E=({mouse:n,vertexShader:i,fragmentShader:l})=>{const c=o.useMemo(()=>new x(2,2),[]),d=o.useRef(null),{size:e,gl:r}=p(),s=o.useMemo(()=>new b({vertexShader:i,fragmentShader:l,uniforms:{u_time:{value:0},u_resolution:{value:new v},u_mouse:{value:new v}}}),[i,l]);return o.useEffect(()=>()=>{s.dispose(),c.dispose()},[s,c]),o.useEffect(()=>{const t=window.devicePixelRatio||2;r.setPixelRatio(t),r.setSize(e.width,e.height),s.uniforms.u_resolution.value.set(e.width,e.height)},[e.width,e.height,r,s]),h(({clock:t})=>{s.uniforms.u_time.value=t.getElapsedTime(),s.uniforms.u_mouse.value.set(n.x,n.y)}),o.useEffect(()=>{const t=r.domElement,m=f=>{f.preventDefault(),console.log("WebGL context lost. Attempting to restore...")},a=()=>{console.log("WebGL context restored"),r.setPixelRatio(window.devicePixelRatio||2),r.setSize(e.width,e.height),s.uniforms.u_resolution.value.set(e.width,e.height)};return t.addEventListener("webglcontextlost",m),t.addEventListener("webglcontextrestored",a),()=>{t.removeEventListener("webglcontextlost",m),t.removeEventListener("webglcontextrestored",a)}},[r,e,s]),o.useEffect(()=>{d.current&&(d.current.position.z=0)},[]),u.jsx("mesh",{ref:d,material:s,geometry:c})},G=({vertexShader:n=`
...
//# sourceMappingURL=demo1.DWuIptSr.js.map
