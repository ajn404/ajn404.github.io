import{j as u}from"./jsx-runtime.A2Jwhp3O.js";import{r as o}from"./index.dFUwPPDs.js";import{C as p,u as g,b as h}from"./react-three-fiber.esm.DdQiZQSM.js";import{P as x,S as w,V as v}from"./three.module.Ddm6rSpf.js";import{S as y}from"./slider.Iti-3coa.js";import{c as b}from"./utils.CfnwmW4g.js";import{u as _}from"./index.BKWCGfoX.js";import"./_sentry-release-injection-file.YJMKEV6W.js";import"./_commonjsHelpers.CZeiIxrb.js";import"./index.DnRsmo8d.js";import"./index.DlJlyF9b.js";import"./index.5SH97iAD.js";import"./index.CTIwX1c4.js";import"./index.BIXfKnox.js";import"./index.CBSYeGst.js";import"./index.BOWpSI3J.js";(function(){try{var n=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},i=new n.Error().stack;i&&(n._sentryDebugIds=n._sentryDebugIds||{},n._sentryDebugIds[i]="2570a013-7072-40af-970d-0574b7181586",n._sentryDebugIdIdentifier="sentry-dbid-2570a013-7072-40af-970d-0574b7181586")}catch{}})();const E=({mouse:n,vertexShader:i,fragmentShader:l})=>{const c=o.useMemo(()=>new x(2,2),[]),m=o.useRef(null),{size:e,gl:r}=g(),s=o.useMemo(()=>new w({vertexShader:i,fragmentShader:l,uniforms:{u_time:{value:0},u_resolution:{value:new v},u_mouse:{value:new v}}}),[i,l]);return o.useEffect(()=>()=>{s.dispose(),c.dispose()},[s,c]),o.useEffect(()=>{const t=window.devicePixelRatio||2;r.setPixelRatio(t),r.setSize(e.width,e.height),s.uniforms.u_resolution.value.set(e.width,e.height)},[e.width,e.height,r,s]),h(({clock:t})=>{s.uniforms.u_time.value=t.getElapsedTime(),s.uniforms.u_mouse.value.set(n.x,n.y)}),o.useEffect(()=>{const t=r.domElement,d=f=>{f.preventDefault(),console.log("WebGL context lost. Attempting to restore...")},a=()=>{console.log("WebGL context restored"),r.setPixelRatio(window.devicePixelRatio||2),r.setSize(e.width,e.height),s.uniforms.u_resolution.value.set(e.width,e.height)};return t.addEventListener("webglcontextlost",d),t.addEventListener("webglcontextrestored",a),()=>{t.removeEventListener("webglcontextlost",d),t.removeEventListener("webglcontextrestored",a)}},[r,e,s]),o.useEffect(()=>{m.current&&(m.current.position.z=0)},[]),u.jsx("mesh",{ref:m,material:s,geometry:c})},A=({vertexShader:n=`
...
//# sourceMappingURL=demo1.CceE6XYC.js.map
