import{j as u}from"./jsx-runtime.Br6NZf7z.js";import{r as o}from"./index.CoDvW3iS.js";import{C as g,u as p,b as h}from"./react-three-fiber.esm.DVKcpZbW.js";import{P as x,S as w,V as v}from"./three.module.CNaziSk3.js";import{S as y}from"./slider.BaRfsUGm.js";import{c as b}from"./utils.C_1_xZt9.js";import{u as _}from"./index.C7Z5W2mr.js";import"./_sentry-release-injection-file.DXPJa_4z.js";import"./_commonjsHelpers.B9f9TEuB.js";import"./index.0XI7MV6c.js";import"./index.C08bI6Cg.js";import"./index.0goxTiHm.js";import"./index.BLYPBNl-.js";import"./index.BOzsX3qf.js";import"./index.B6GaQdwz.js";(function(){try{var n=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{},i=new n.Error().stack;i&&(n._sentryDebugIds=n._sentryDebugIds||{},n._sentryDebugIds[i]="1db9e850-a579-413c-a42f-125528ce8153",n._sentryDebugIdIdentifier="sentry-dbid-1db9e850-a579-413c-a42f-125528ce8153")}catch{}})();const E=({mouse:n,vertexShader:i,fragmentShader:l})=>{const c=o.useMemo(()=>new x(2,2),[]),d=o.useRef(null),{size:e,gl:r}=p(),s=o.useMemo(()=>new w({vertexShader:i,fragmentShader:l,uniforms:{u_time:{value:0},u_resolution:{value:new v},u_mouse:{value:new v}}}),[i,l]);return o.useEffect(()=>()=>{s.dispose(),c.dispose()},[s,c]),o.useEffect(()=>{const t=window.devicePixelRatio||2;r.setPixelRatio(t),r.setSize(e.width,e.height),s.uniforms.u_resolution.value.set(e.width,e.height)},[e.width,e.height,r,s]),h(({clock:t})=>{s.uniforms.u_time.value=t.getElapsedTime(),s.uniforms.u_mouse.value.set(n.x,n.y)}),o.useEffect(()=>{const t=r.domElement,m=f=>{f.preventDefault(),console.log("WebGL context lost. Attempting to restore...")},a=()=>{console.log("WebGL context restored"),r.setPixelRatio(window.devicePixelRatio||2),r.setSize(e.width,e.height),s.uniforms.u_resolution.value.set(e.width,e.height)};return t.addEventListener("webglcontextlost",m),t.addEventListener("webglcontextrestored",a),()=>{t.removeEventListener("webglcontextlost",m),t.removeEventListener("webglcontextrestored",a)}},[r,e,s]),o.useEffect(()=>{d.current&&(d.current.position.z=0)},[]),u.jsx("mesh",{ref:d,material:s,geometry:c})},G=({vertexShader:n=`
...
//# sourceMappingURL=demo1.B1EWsrIh.js.map
