...
<p class="zig-zag-box-v1 text-center indent-2 grid place-content-center font-xkcd text-2xl">
...
<div class="grid place-content-center w-full grid-cols-[auto_auto] gap-[20px] pt-[40px]">
  <progress value=".5"></progress>
  <progress value=".2"></progress>
  <progress value=".7" class="bottom"></progress>
